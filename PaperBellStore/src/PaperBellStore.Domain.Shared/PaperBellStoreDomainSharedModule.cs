...
public class PaperBellStoreDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        PaperBellStoreGlobalFeatureConfigurator.Configure();
        PaperBellStoreModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<PaperBellStoreDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<PaperBellStoreResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/PaperBellStore");

            options.DefaultResourceType=typeof(PaperBellStoreResource);
        ...
        {
            options.MapCodeNamespace("PaperBellStore" , typeof(PaperBellStoreResource));
        });
    }
}
