...
namespace PaperBellStore.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["PaperBellStore_App:ClientId"];
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["PaperBellStore_Swagger:ClientId"];
